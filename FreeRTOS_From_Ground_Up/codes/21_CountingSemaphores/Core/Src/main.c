/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : This code uses a counting semaphore to handle two
  * peripherals: gpio and adc drivers. This kind of semaphore can handle more
  * than two tasks.
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
   ...
   * First argument: total count.
   * Second argument: initial count. If the count starts on 1, the key is
   * given to the first task. This avoids to use xSemaphoreGive function.
   * */
  ...
  /*The semaphore start giving key to start the sequence*/
