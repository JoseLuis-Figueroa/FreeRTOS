/**
  ...
  * using a interrupt. The code does not work, the problem is related to the
  * baud rate. It was not fix as it is using the stm32 hal.
  ******************************************************************************
  * @attention
  *
...
void USART2_IRQHandler(void)
{
	...
	if(USART2->SR & USART_SR_RXNE)
	{
		...
		if(rxInProgress)
		{
			xQueueSendFromISR(UART2_BytesReceived, &temperatureValue, &xHigherPriorityTaskWoken);
		}
	}
